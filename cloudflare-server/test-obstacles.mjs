...
const m=a.makeMatch(['1','2','3','4','5','6']);m.map='factory';m.crates=[[450,330],[450,30]].map(([x,y],id)=>({id:`crate-${id}`,x,y,w:60,h:60,hp:100,maxHp:100,destructible:true}));
...
const enemy=m.players.get('4');enemy.x=420;enemy.y=60;m.bullets=[{x:370,y:60,vx:1000,vy:0,life:1,damage:22,team:'blue',owner:'1'}];a.updateBullets(m,.1);assert.equal(enemy.hp,78);assert.equal(m.crates[1].hp,100);
